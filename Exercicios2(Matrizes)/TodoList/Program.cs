...
namespace TodoList {
    class Program {
        ...
        static List<TodoItem> initList (string filePath) {
            List<TodoItem> todoList = new List<TodoItem> (); //inicializa a tarefa

            try {
                string[] todoFile = File.ReadAllLines (@filePath); ///le o arquivo
                ...
                todoList.RemoveAt (0); //remove o cabecalho 
                return todoList;
